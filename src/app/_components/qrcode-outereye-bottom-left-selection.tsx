...
function QRCodeOuterEyeBottomLeftSelection() {
  const { changeQROuterEyeBottomLeft } = useQRCode();
  const [index, setIndex] = useState<string>(`0`);

  const handleOuterEyeChange = (value: string) => {
    changeQROuterEyeBottomLeft(value);
    setIndex(value);
  };
  ...
  return (
    <div className="mb-4 flex flex-col gap-2">
      <Label className="flex">
        Formato da moldura do olho inferior esquerdo:
      </Label>
...
export { QRCodeOuterEyeBottomLeftSelection };
