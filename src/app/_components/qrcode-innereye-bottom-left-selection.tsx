...
function QRCodeInnerEyeBottomLeftSelection() {
  const { changeQRInnerEyeBottomLeft } = useQRCode();
  const [index, setIndex] = useState<string>(`0`);

  const handleInnerEyeChange = (value: string) => {
    changeQRInnerEyeBottomLeft(value);
    setIndex(value);
  };
  ...
  return (
    <div className="mb-4 flex flex-col gap-2">
      <Label className="flex">
        Formato do centro do olho inferior esquerdo:
      </Label>
...
export { QRCodeInnerEyeBottomLeftSelection };
