...
function QRCodeOuterEyeTopLeftSelection() {
  const { changeQROuterEyeTopLeft } = useQRCode();
  const [index, setIndex] = useState<string>(`0`);

  const handleOuterEyeChange = (value: string) => {
    changeQROuterEyeTopLeft(value);
    setIndex(value);
  };
  ...
  return (
    <div className="mb-4 flex flex-col gap-2">
      <Label className="flex">
        Formato da moldura do olho superior esquerdo:
      </Label>
...
export { QRCodeOuterEyeTopLeftSelection };
