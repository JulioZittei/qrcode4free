...
function QRCodeInnerEyeTopLeftSelection() {
  const { changeQRInnerEyeTopLeft } = useQRCode();
  const [index, setIndex] = useState<string>(`0`);

  const handleInnerEyeChange = (value: string) => {
    changeQRInnerEyeTopLeft(value);
    setIndex(value);
  };
  ...
  return (
    <div className="mb-4 flex flex-col gap-2">
      <Label className="flex">
        Formato do centro do olho superior esquerdo:
      </Label>
...
export { QRCodeInnerEyeTopLeftSelection };
